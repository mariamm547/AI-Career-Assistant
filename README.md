...
Then Install the files from the repo: app.py , backend.py , requirements.txt and Project_notebook.ipynb.
...
- Open app.py and set the API_BASE_URL variable to the ngrok URL from Kaggle: API_BASE_URL = "https://xxxx.ngrok.io"
